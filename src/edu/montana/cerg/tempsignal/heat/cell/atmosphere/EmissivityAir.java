 ...
 * @author robert.payn
 */
public class EmissivityAir extends AutoDynamDouble {
	...
	public double calculate() 
	{
		...
		//return 1.72 * Math.pow(((0.1*vapPressAir.value)/(tempK.value)),  0.1428571);
		
		// following adjusted Brutsaert:
		return 1.72 * Math.pow(((0.1*vapPressAir.value)/(tempK.value)), 0.1428571) * 1.10;
