 ...
 * @author robert.payn
 */
public class VaporPressureSatAir extends AutoDynamDouble {
	...
	/**
	 * Calculates the saturated vapor pressure at the air temperature
	 * 
	...
	{
		return 6.1275 * Math.exp(17.2693882 * (tempCelsius.value / (tempCelsius.value + Constants.C_MINUS_K - 35.86)));	
	}
