...
import edu.montana.cerg.tempsignal.heat.cell.channel.mechanistic.LatentVapWater;
...
public class HeatLatentEvap extends ManualDynamDouble {
	...
	public double calculate() 
	{
		...
		return (evaporation.value * (latentVapWater.value));
	...
	public void setCalcDeps()
	{
		...
		latentVapWater = (StateDouble)createDependency(toCell,LatentVapWater.class.getSimpleName());
	}
