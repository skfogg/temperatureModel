...
public class BowenRatio extends ManualDynamDouble {
	...
	{
		if (vaporPressureSat.value == vaporPressureAir.value)
    // When Air and water vapor pressures are equal, there will be no evaporation
	// Bowen ratio is multiplied by evaporation rate.  Therefore, we return 0 to avoid
	// division by zero in 'else' statement below.
			return 0.0;
		else
